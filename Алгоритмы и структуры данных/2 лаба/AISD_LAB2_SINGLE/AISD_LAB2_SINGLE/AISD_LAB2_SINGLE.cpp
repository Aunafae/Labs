...
int main() {
	...
	cout << timer * 0.000001 << "мс" << endl;
	cout << (timer * 0.000001) / test_count << "мс - среднее время на одну вставку" << endl;
	...
	cout << timer * 0.000001 << "мс" << endl;
	cout << (timer * 0.000001) / test_count << "мс - среднее время на одно удаление" << endl;
	system("pause");
