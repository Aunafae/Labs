...
void CreateControls(HWND hwnd) {
    ...
    CreateWindow(L"BUTTON", L"Установить", WS_VISIBLE | WS_CHILD, 410, 20, 100, 30, hwnd, (HMENU)1, NULL, NULL);
    ...
    CreateWindow(L"BUTTON", L"Добавить", WS_VISIBLE | WS_CHILD, 410, 70, 100, 30, hwnd, (HMENU)2, NULL, NULL);
    ...
    CreateWindow(L"BUTTON", L"Найти путь", WS_VISIBLE | WS_CHILD, 410, 120, 100, 30, hwnd, (HMENU)3, NULL, NULL);
